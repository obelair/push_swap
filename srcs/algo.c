...
/*   Updated: 2021/08/31 22:48:28 by obelair          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sorting_3(t_data *td)
{
	...
	cmp_top_stack(td);
	if (td->a->lst->ind == td->f_hold && ascending_sort(td->a->lst))
		ra(td, 0);
...
void	sorting_5(t_data *td)
{
	...
	if (ft_abs(ind_element(td->a->lst, td->a->len, td->f_hold)) > ft_abs(ind_element(td->a->lst, td->a->len, td->s_hold)))
